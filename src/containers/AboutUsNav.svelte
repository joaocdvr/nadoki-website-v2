...
>
  <li class:li-open={isAnyAboutUsItemActive}>
    <a
      ...
      class:selected-a={$aboutUsActiveItem === 'julia'}
      ...
      <div>
        ...
        <h2
          class="body-bold"
          class:selected-text={$aboutUsActiveItem === 'julia'}
        >
  ...
  <li class:li-open={isAnyAboutUsItemActive}>
    <a
      ...
      class:a-open={isAnyAboutUsItemActive}
      class:selected-a={$aboutUsActiveItem === 'elia'}
      ...
      <div>
        ...
        <h2
          class="body-bold"
          class:selected-text={$aboutUsActiveItem === 'elia'}
        >
  ...
  <li class:li-open={isAnyAboutUsItemActive}>
    <a
      href="/about_us?name=yuval"
      class:a-open={isAnyAboutUsItemActive}
      class:selected-a={$aboutUsActiveItem === 'yuval'}
      on:click={(event) => handleClick(event, handleAboutUsItemClick('yuval'))}
      aria-label="Toggle Yuval Miller's details"
      aria-pressed={$aboutUsActiveItem === 'yuval'}>
      <div>
        <img
          class:img-open={isAnyAboutUsItemActive}
          src="about_us/yuval.png"
          alt="Yuval Miller's face in a meat package created with an Instagram
          filter"
        />

        <h2
          class="body-bold"
          class:selected-text={$aboutUsActiveItem === 'yuval'}
        >
          {#if isAnyAboutUsItemActive}Yuval{:else}Yuval Miller{/if}
        </h2>
      </div>

      <svg
        id="svg-to-animate-yuval"
        preserveAspectRatio="none"
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 80 80"
        aria-hidden="true">
