...
<div
  ...
  {#if $servicesModalActive === 'music'}
    ...
    <Tab tab={musicTab} delay={$animationInDelay} />
  ...
  {:else if $servicesModalActive === 'film'}
    ...
    <Tab tab={filmTab} delay={$animationInDelay} />
    <div class="tab-content">
  ...
  {:else if $servicesModalActive === 'game'}
    ...
    <Tab tab={gameTab} delay={$animationInDelay} />
    <div class="tab-content">
  ...
  {:else if $servicesModalActive === 'branding'}
    ...
    <Tab tab={brandingTab} delay={$animationInDelay} />
    <div class="tab-content">
