<script>
  ...
  let hardwareList = [
    ...
    },
    {
      ...
      name: "Microphones",
      content:
        "Dynamic<br>— Shure SM57<br>— SM7<br>— AKG P4 (x4)<br>— AKG P2<br><br>Condenser<br>— AKG C414 XLS<br>— Neumann TLM 103 Studio Set<br>— Neumann KM 184 (pair)<br>— Bluebird<br>— Yeti Blue Digital Mic<br>— AKG P17 (pair)"
    },
    {
      open: false,
      name: "Ourboard",
